...
<div class="main-header">
    ...
    <p>Tác giả: Hoàng Văn Đạt - Trường PTDTBT Tiểu học Quảng Nguyên - ĐT: 0949779622</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Hoàng Văn Đạt - Trường PTDTBT Tiểu học Quảng Nguyên - ĐT: 0949779622</div>", unsafe_allow_html=True)
